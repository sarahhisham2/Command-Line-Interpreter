...
public class Terminal
{
    public void cp(String sourcePath, String destinationPath) throws IOException {
        ...
        else if(new File(sourcePath).isFile() && new File(destinationPath).isDirectory())
        {

            Path fromPath = Paths.get(sourcePath);
            Path targetPath = Paths.get(destinationPath);

            cp(fromPath.toString(),targetPath.toString());
        }
    ...
    public void mv(String sourcePath, String destinationPath) throws IOException {
        // if moving file to other file in same directory, it's like rename
            ...
            File destFile = new File(handlePath(destinationPath));
